...
def insert_frida_lib():
        ...
        if args['fix']:
                ...
                if args['arch'] == 'all':
                        ...
                        copyfile('res/frida-gadget-12.11.18-android-arm.so','unpacked/lib//armeabi/libfrida-gadget.so')
                        copyfile('res/frida-gadget-12.11.18-android-arm.so','unpacked/lib/armeabi-v7a/libfrida-gadget.so')
                        copyfile('res/frida-gadget-12.11.18-android-arm64.so','unpacked/lib/arm64-v8a/libfrida-gadget.so')
                        copyfile('res/frida-gadget-12.11.18-android-x86.so','unpacked/lib/x86/libfrida-gadget.so')
                        copyfile('res/frida-gadget-12.11.18-android-x86_64.so','unpacked/lib/x86_64/libfrida-gadget.so')
                else: 
                        # Use a specific arch   
                        ...
                        if 'arm' in args['arch']:
                                if 'arm64' in args['arch']:
                                        t_file = 'frida-gadget-12.11.18-android-arm64.so'
                                else:
                                        t_file = 'frida-gadget-12.11.18-android-arm.so'
                        if 'x86' in args['arch']:
                                t_file = 'frida-gadget-12.11.18-android-x86.so'
                        if 'x86_64' in args['arch']:
                                t_file = 'frida-gadget-12.11.18-android-x86_64.so'
